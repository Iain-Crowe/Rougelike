...
"""
    ...
    If an action is returned it will attempt the action and if it's valid, then MainGameEventHandler
    will become active.
"""
...
class EventHandler(BaseEventHandler):
    ...
    def handle_events(self, event: tcod.event.Event) -> BaseEventHandler:
        ...
        if self.handle_action(action_or_state):
            ...
            if not self.engine.player.is_alive:
                # The player died sometime during or after the action
    ...
    def handle_action(self, action: Optional[Action]) -> BaseEventHandler:
        """
...
class LevelUpEventHandler(AskUserEventHandler):
    ...
    def on_render(self, console: tcod.console.Console) -> None:
        ...
        console.print(x=x + 1, y=1, string="Congragulations! You level up!")
        console.print(x=x + 1, y=2, string="Select an attribute to increase.")

        console.print(
            x=x + 1,
            y=4,
            string=f"a) Consitution (+20 HP, from {self.engine.player.fighter.max_hp})"
        )
        console.print(
            x=x + 1,
            y=5,
...
class CharacterScreenEventHandler(AskUserEventHandler):
    ...
    def on_render(self, console: tcod.console.Console) -> None:
        ...
        console.print(
            x=x + 1,
            y=y + 3,
            string=f"XP to next level: {self.engine.player.level.experience_to_next_level}"
        )
        console.print(
